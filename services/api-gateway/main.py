...
async def stats(user=Depends(verify_firebase_token)):
    ...
    # ⚡ Bolt Optimization: Offload blocking synchronous I/O queries to threads
    # and execute them concurrently with asyncio.gather to avoid event loop blocking
    # and to reduce the 4 sequential network roundtrips into 1 concurrent roundtrip.
