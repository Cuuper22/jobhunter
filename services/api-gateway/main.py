...
async def stats(user=Depends(verify_firebase_token)):
    ...
    # ⚡ Bolt: Run independent Firestore count aggregations concurrently in separate threads
    # to avoid blocking the asyncio event loop and reduce total response latency.
