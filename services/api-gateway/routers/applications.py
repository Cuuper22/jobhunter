...
async def list_applications(
    ...
    # Offload synchronous Firestore query to thread to prevent blocking the event loop
...
async def list_pending(user=Depends(verify_firebase_token)):
    ...
    # Offload synchronous Firestore query to thread
...
async def get_application(app_id: str, user=Depends(verify_firebase_token)):
    # Offload synchronous Firestore get to thread
...
async def update_application(
    ...
    # Offload synchronous Firestore update to thread
...
async def approve_application(
    ...
    # Offload synchronous shared firestore writes to thread
